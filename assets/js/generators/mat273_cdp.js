...
// - ro (optional): blank/0 => 0.0023 g/mm^3
...
const MODEL_LINE = "$ Model: Concrete Damage Plasticity (CDP) - MAT 273";
const REF_LINES = [
  "$ Reference: Zhao, M. Z., Lehman, D. E., & Roeder, C. W. (2021).",
  "$ Modeling recommendations for RC and CFST sections in LS-Dyna including bond slip.",
  "$ Engineering Structures, 229, 111612.",
  "$ https://doi.org/10.1016/j.engstruct.2020.111612",
];
...
export const FIELDS = [
  ...
  {
    key: "ro",
    label: "Density RO (optional)",
    unit: "g/mm^3",
    default: "",
    hint: "Typical 0.0022–0.0024. Leave blank/0 to use 0.0023.",
  },
