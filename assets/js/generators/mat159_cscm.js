// assets/js/generators/159_cscm.js
...
export const generator = {
  id: "159_cscm",
  sort: 159,
  name: "CSCM Concrete (*MAT_CSCM)",
  category: "Concrete",
  units: "mm-ms-g-N-MPa",
  description:
    "CSCM concrete keyword generator with deterministic MID, defaults, validation, and stable formatting.",
  ...
  fields: [
    { key: "fc_mpa", label: "Compressive strength (fc)", unit: "MPa", type: "number", step: 0.1, min: 1 },
    { key: "dmax_mm", label: "Max aggregate size (dmax)", unit: "mm", type: "number", step: 0.1, min: 1 },
    { key: "mid", label: "Material ID (MID)", unit: "-", type: "integer", step: 1, min: 1 },

    { key: "ro", label: "Density (RO)", unit: "g/mm^3", type: "number", step: 0.0001, min: 0.0001 },
    { key: "erode", label: "ERODE", unit: "-", type: "number", step: 0.01, min: 0 },
    { key: "poisson_ratio", label: "Poisson ratio (PR)", unit: "-", type: "number", step: 0.01, min: 0, max: 0.49 },

    { key: "w", label: "W", unit: "-", type: "number", step: 0.001, advanced: true },
    { key: "d1", label: "D1", unit: "-", type: "number", step: 0.000001, advanced: true },
    { key: "d2", label: "D2", unit: "-", type: "number", step: 0.000001, advanced: true },
    { key: "B", label: "B", unit: "-", type: "number", step: 1, advanced: true },
    { key: "D", label: "D", unit: "-", type: "number", step: 0.01, advanced: true },
    { key: "PWRC", label: "PWRC", unit: "-", type: "number", step: 1, advanced: true },
    { key: "PWRT", label: "PWRT", unit: "-", type: "number", step: 1, advanced: true },
    { key: "PMOD", label: "PMOD", unit: "-", type: "number", step: 1, advanced: true },
  ],

  generate(input = {}) {
    const inp = { ...this.defaults, ...input };
