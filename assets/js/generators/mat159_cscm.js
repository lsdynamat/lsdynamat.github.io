...
// Header lines (user-visible in the generated keyword)
...
function renderKeyword(f, p) {
  ...
  // The line right after *MAT_CSCM_TITLE (your preferred style)
  ...
  // Keep your original reference info (content unchanged)
