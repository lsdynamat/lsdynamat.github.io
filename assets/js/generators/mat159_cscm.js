...
// ---- header comment lines (top-level as usual)
const UNITS_LINE = "$ Units: mm-ms-g-N-MPa";

// put REF lines "up top" as you requested
const REF_LINES = [
...
export const DEFAULTS = {
  ...
  ro: 0.0023,   // g/mm^3
  pr: 0.20,     // Poisson ratio
};

// Optional: if later you auto-sync materials.json
export const FIELDS = [
  { key: "fc",   label: "Compressive strength (fc)", unit: "MPa",    type: "number",  step: 0.1,    min: 1,    default: DEFAULTS.fc,   hint: "Example: 30.0" },
  { key: "dmax", label: "Max aggregate size (dmax)", unit: "mm",     type: "number",  step: 0.1,    min: 1,    default: DEFAULTS.dmax, hint: "Example: 16" },
  { key: "mid",  label: "Material ID (MID)",         unit: "-",      type: "integer", step: 1,      min: 1,    default: DEFAULTS.mid,  hint: "Example: 1001" },

  { key: "ro",   label: "Density (RO)",              unit: "g/mm^3",  type: "number",  step: 0.0001, min: 0.000001, default: DEFAULTS.ro, hint: "Typical: 0.0023" },
...
// ------------------------
// Keyword rendering (format you asked, but constants stay up top)
